...
echo ============================================================
echo Building %APP%.exe GUI NO-CONSOLE EXPERIMENTAL - Ver6
echo ============================================================
echo.
echo This mode may fail silently on some PCs. Use 01_BUILD_EXE_NUITKA.bat for the confirmed stable build.
echo.
...
echo Build complete: dist\%APP%.exe
pause
