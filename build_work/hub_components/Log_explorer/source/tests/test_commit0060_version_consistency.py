...
EXPECTED_VERSION = "2.0.0-rc1-commit0060"
EXPECTED_COMMIT = "Commit0060"
EXPECTED_EXE = "LogMergeTool_RC1_Commit0060.exe"
...
for bat_name in ("01_BUILD_EXE_GITHUB.bat", "01_BUILD_EXE_NUITKA.bat"):
    ...
    assert "Commit0060" in bat, bat_name
    assert "csa_error_rules.json" in bat, bat_name
    assert "site_serial_map.json" in bat, bat_name

print("Commit0060 version consistency: PASS")


def test_commit0060_filter_bindings_present():
    source = (ROOT / "LogMergeTool_NoExcel_Main.py").read_text(encoding="utf-8")
